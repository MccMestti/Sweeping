            ...
            <div class="row">
                ...
                <div class="col-xs-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Bombas encontradas </li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <!-- WIDGET:CATEGORIES - START -->
                    <div class="widget widget-navigation">
                        <ul class="nav nav-pills nav-stacked">
                            ...
                            <li class="active"><a href="tabelabombas.php">Tabela de bombas encontradas</a></li>
                        </ul>
                    </div>
            ...
            <table class="table table-striped" style="width:80%">
                <thead>
                    <tr>
                        ...
                        <th scope="col">BOMBAS ENCONTRADAS</th>
...
=========================== -->        
    ...
    <script type = "text/javascript">
        ...
        var query2=" ORDER BY `bombas` DESC ";
    function ver_mais(){
    ...
    function pesquisa(){
        ...
        if (string=='()'){
            ...
            var sql=query+ " WHERE `id_jogador` IN " + string +" AND `bombas`!=0 "+ query2 ;
            var sql_limit=sql+ " LIMIT "+user_count;
        }

        $.ajax({
            url:'/ajax_tabelabomba.php',
            method:'POST',
            data:{sql:sql_limit},
            error:function(){
