                ...
                <!-- WIDGET:CATEGORIES - START -->
                    <div class="widget widget-navigation">
                        <ul class="nav nav-pills nav-stacked">
                            <li class="active"><a href="tabelapontos.php">Tabela de pontos</a></li>
...
=========================== -->        
    ...
    <script type = "text/javascript">
        ...
        var query2=" ORDER BY `pontos` DESC ";
    function ver_mais(){
    ...
    function pesquisa(){
        ...
        if (string=='()'){
            ...
            var sql=query+ " WHERE `id_jogador` IN " + string +" AND `pontos`!=0 "+ query2 ;
            var sql_limit=sql+ " LIMIT "+user_count;
        }

        $.ajax({
            url:'/ajax_tabelapontos.php',
            method:'POST',
            data:{sql:sql_limit},
            error:function(){
